...
class OutgoingGeneralUrlPreviewTempMessageTableViewCell: UITableViewCell {
  ...
  func getHeightOfViewCell() -> CGFloat {
    let fullMessage = self.buildMessage()
    let fullMessageRect: CGRect = fullMessage.boundingRect(with: CGSize(width: self.messageLabelWidth.constant, height: CGFloat.greatestFiniteMagnitude), options: NSStringDrawingOptions.usesLineFragmentOrigin, context: nil)
