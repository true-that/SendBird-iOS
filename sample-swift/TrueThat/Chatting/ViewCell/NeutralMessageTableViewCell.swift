...
class NeutralMessageTableViewCell: UITableViewCell {
  ...
  func buildMessage() -> NSAttributedString {
    ...
    let fullMessage = NSMutableAttributedString(string: message! as String)
  ...
  func getHeightOfViewCell() -> CGFloat {
    ...
    fullMessageRect = fullMessage.boundingRect(with: CGSize(width: messageLabelMaxWidth, height: CGFloat.greatestFiniteMagnitude), options: NSStringDrawingOptions.usesLineFragmentOrigin, context: nil)
